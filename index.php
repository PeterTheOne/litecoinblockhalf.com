...
<body>
	<div class="container">
		...
		<div style="text-align:center">
			...
			<p>The Litecoin block mining reward halves every <?=number_format($blockHalvingSubsidy)?> blocks, the coin reward will decrease from <?=$blockReward?> to <?=$blockReward / 2 ?> coins. You can watch an educational video by the <a href="https://litecoin.org/">Litecoin Project</a> explaining it in more detail below:</p>
